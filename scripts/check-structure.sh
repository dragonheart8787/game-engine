...
required_cpp=(
  ...
  "engine/include/weavebound/version.hpp"
  "engine/include/weavebound/weavebound.hpp"
  "engine/src/core.cpp"
  "engine/src/weavebound/platform/clock_std.cpp"
  "engine/src/weavebound/platform/win32/window_win32.cpp"
  "engine/src/weavebound/rhi/vulkan/device_vulkan.cpp"
  "engine/shaders/triangle.vert"
  "engine/shaders/triangle.frag"
  "scripts/bootstrap/download_deps_windows.ps1"
  "scripts/bootstrap/download_deps_linux.sh"
  "scripts/bootstrap/compile_shaders.ps1"
  "scripts/bootstrap/compile_shaders.sh"
  "apps/smoke/main.cpp"
  "tools/README.md"
  "assets/.keep"
